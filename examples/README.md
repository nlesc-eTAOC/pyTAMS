...
*pyREVS* comes with a suite of examples referred to throughout the documentation
...
implementation in *pyREVS* (albeit fully in Python).

## BoussinesqCpp
A C++ version of the Boussinesq model, showing how to couple
*pyREVS* with an external software.
...
## OrnsteinUhlenbeck
A 1D Ornstein-Uhlenbeck process, used in validating *pyREVS*.
