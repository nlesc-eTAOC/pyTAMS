...
Finally, let's update the sample script to extract more information from the TAMS
run:
...
The updated script above access the TAMS database to show the history of the
